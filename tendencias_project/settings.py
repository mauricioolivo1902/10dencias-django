...
ALLOWED_HOSTS = ['estebanolivo.pythonanywhere.com', '127.0.0.1', 'localhost']
...
ROOT_URLCONF = 'tendencias_project.urls'
...
WSGI_APPLICATION = 'tendencias_project.wsgi.application'
