...
def seed_data(apps, schema_editor):
    ...
    productos = [
        {"nombre": "Taza Inspiradora", "precio": 12.50, "url_imagen": "https://via.placeholder.com/300x300.png?text=Taza"},
        {"nombre": "Camiseta Motivacional", "precio": 25.00, "url_imagen": "https://via.placeholder.com/300x300.png?text=Camiseta"},
        {"nombre": "Hoodie con Actitud", "precio": 45.00, "url_imagen": "https://via.placeholder.com/300x300.png?text=Hoodie"},
        {"nombre": "Gorra de Metas", "precio": 18.00, "url_imagen": "https://via.placeholder.com/300x300.png?text=Gorra"},
    ]
